...
class DorisServiceAdvisor(service_advisor.ServiceAdvisor):
    ...
    def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
        ...
        recommender.recommendDorisConfigurationsFromNDP(configurations, clusterData, services, hosts)
...
class DorisRecommender(service_advisor.ServiceAdvisor):
    ...
    def recommendDorisConfigurationsFromNDP(self, configurations, clusterData, services, hosts):
